...
for exp in ['', '_bias_corrected_th04']:  # , 'long_ITI_0208']:
    ...
    plt.show()
    # save figure
    f.savefig(folder+'/perf_boxplot'+exp+'.png')
    f.savefig(folder+'/perf_boxplot'+exp+'.svg')
